                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> 1
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 2
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 3
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 4
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 5
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 6
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 7
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 8
                                </li>
                            </ul>
                        </div>
                    </div>
